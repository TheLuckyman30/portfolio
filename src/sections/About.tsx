...
export function About() {
  ...
  const aboutMeText = [
    "I am an aspiring software engineer/full-stack developer. I am a recent graduate of the University of Delaware with a Bachelor of Science in Computer Science and minors in Game Studies and Interactive Media. ",
